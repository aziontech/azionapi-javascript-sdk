...
* <pre>
* var NetworkListsApi = require('index'); // See note below*.
* var xxxSvc = new NetworkListsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new NetworkListsApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new NetworkListsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new NetworkListsApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
