...
class BadRequestResponse {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['list_type'])) {
            throw new Error("Expected the field `list_type` to be an array in the JSON data but got " + data['list_type']);
        }
 ...
 */
BadRequestResponse.prototype['items_values'] = undefined;

/**
 * @member {Array.<String>} list_type
 */
BadRequestResponse.prototype['list_type'] = undefined;
