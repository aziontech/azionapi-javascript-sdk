...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkListsApi.NetworkListUuidResponseEntryString();
  });
  ...
  describe('NetworkListUuidResponseEntryString', function() {
    it('should create an instance of NetworkListUuidResponseEntryString', function() {
      // uncomment below and update the code to test NetworkListUuidResponseEntryString
      //var instance = new NetworkListsApi.NetworkListUuidResponseEntryString();
      //expect(instance).to.be.a(NetworkListsApi.NetworkListUuidResponseEntryString);
    });
