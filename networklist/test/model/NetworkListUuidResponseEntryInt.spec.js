...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkListsApi.NetworkListUuidResponseEntryInt();
  });
  ...
  describe('NetworkListUuidResponseEntryInt', function() {
    it('should create an instance of NetworkListUuidResponseEntryInt', function() {
      // uncomment below and update the code to test NetworkListUuidResponseEntryInt
      //var instance = new NetworkListsApi.NetworkListUuidResponseEntryInt();
      //expect(instance).to.be.a(NetworkListsApi.NetworkListUuidResponseEntryInt);
    });
