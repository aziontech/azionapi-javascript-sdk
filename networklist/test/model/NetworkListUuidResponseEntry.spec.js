...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkListsApi.NetworkListUuidResponseEntry();
  });
  ...
  describe('NetworkListUuidResponseEntry', function() {
    it('should create an instance of NetworkListUuidResponseEntry', function() {
      // uncomment below and update the code to test NetworkListUuidResponseEntry
      //var instance = new NetworkListsApi.NetworkListUuidResponseEntry();
      //expect(instance).to.be.a(NetworkListsApi.NetworkListUuidResponseEntry);
    });
