...
* <pre>
* var IntelligentDnsApi = require('index'); // See note below*.
* var xxxSvc = new IntelligentDnsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new IntelligentDnsApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new IntelligentDnsApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new IntelligentDnsApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
