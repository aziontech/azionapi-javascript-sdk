...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentDns.RecordGet();
  });
  ...
  describe('RecordGet', function() {
    it('should create an instance of RecordGet', function() {
      // uncomment below and update the code to test RecordGet
      //var instance = new IntelligentDns.RecordGet();
      //expect(instance).to.be.a(IntelligentDns.RecordGet);
    });
