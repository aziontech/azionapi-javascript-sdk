...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntelligentDns.GetRecordsResponse();
  });
  ...
  describe('GetRecordsResponse', function() {
    it('should create an instance of GetRecordsResponse', function() {
      // uncomment below and update the code to test GetRecordsResponse
      //var instance = new IntelligentDns.GetRecordsResponse();
      //expect(instance).to.be.a(IntelligentDns.GetRecordsResponse);
    });
