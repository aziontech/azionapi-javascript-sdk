...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServicesApi.CreateServiceRequest();
  });
  ...
  describe('CreateServiceRequest', function() {
    it('should create an instance of CreateServiceRequest', function() {
      ...
      //var instance = new ServicesApi.CreateServiceRequest();
      //expect(instance).to.be.a(ServicesApi.CreateServiceRequest);
    });
