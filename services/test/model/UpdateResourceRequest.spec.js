...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServicesApi.UpdateResourceRequest();
  });
  ...
  describe('UpdateResourceRequest', function() {
    it('should create an instance of UpdateResourceRequest', function() {
      ...
      //var instance = new ServicesApi.UpdateResourceRequest();
      //expect(instance).to.be.a(ServicesApi.UpdateResourceRequest);
    });
