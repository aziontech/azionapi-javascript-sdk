...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServicesApi.ServiceResponse();
  });
  ...
  describe('ServiceResponse', function() {
    it('should create an instance of ServiceResponse', function() {
      ...
      //var instance = new ServicesApi.ServiceResponse();
      //expect(instance).to.be.a(ServicesApi.ServiceResponse);
    });
    ...
    it('should have the property boundNodes (base name: "bound_nodes")', function() {
      // uncomment below and update the code to test the property boundNodes
      //var instance = new ServicesApi.ServiceResponse();
      //expect(instance).to.be();
    });
