...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.ApplicationCacheCreateRequest();
  });
  ...
  describe('ApplicationCacheCreateRequest', function() {
    it('should create an instance of ApplicationCacheCreateRequest', function() {
      // uncomment below and update the code to test ApplicationCacheCreateRequest
      //var instance = new EdgeApplication.ApplicationCacheCreateRequest();
      //expect(instance).to.be.a(EdgeApplication.ApplicationCacheCreateRequest);
    });
