...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.ApplicationCacheResults();
  });
  ...
  describe('ApplicationCacheResults', function() {
    it('should create an instance of ApplicationCacheResults', function() {
      // uncomment below and update the code to test ApplicationCacheResults
      //var instance = new EdgeApplication.ApplicationCacheResults();
      //expect(instance).to.be.a(EdgeApplication.ApplicationCacheResults);
    });
