...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.OriginsResponse();
  });
  ...
  describe('OriginsResponse', function() {
    it('should create an instance of OriginsResponse', function() {
      // uncomment below and update the code to test OriginsResponse
      //var instance = new EdgeApplication.OriginsResponse();
      //expect(instance).to.be.a(EdgeApplication.OriginsResponse);
    });
