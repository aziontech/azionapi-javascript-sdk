...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.RulesEngineCriteria();
  });
  ...
  describe('RulesEngineCriteria', function() {
    it('should create an instance of RulesEngineCriteria', function() {
      // uncomment below and update the code to test RulesEngineCriteria
      //var instance = new EdgeApplication.RulesEngineCriteria();
      //expect(instance).to.be.a(EdgeApplication.RulesEngineCriteria);
    });
