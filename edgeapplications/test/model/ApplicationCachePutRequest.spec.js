...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.ApplicationCachePutRequest();
  });
  ...
  describe('ApplicationCachePutRequest', function() {
    it('should create an instance of ApplicationCachePutRequest', function() {
      // uncomment below and update the code to test ApplicationCachePutRequest
      //var instance = new EdgeApplication.ApplicationCachePutRequest();
      //expect(instance).to.be.a(EdgeApplication.ApplicationCachePutRequest);
    });
