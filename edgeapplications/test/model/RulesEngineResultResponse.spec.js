...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.RulesEngineResultResponse();
  });
  ...
  describe('RulesEngineResultResponse', function() {
    it('should create an instance of RulesEngineResultResponse', function() {
      // uncomment below and update the code to test RulesEngineResultResponse
      //var instance = new EdgeApplication.RulesEngineResultResponse();
      //expect(instance).to.be.a(EdgeApplication.RulesEngineResultResponse);
    });
