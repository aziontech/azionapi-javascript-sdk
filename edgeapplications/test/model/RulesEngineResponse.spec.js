...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.RulesEngineResponse();
  });
  ...
  describe('RulesEngineResponse', function() {
    it('should create an instance of RulesEngineResponse', function() {
      // uncomment below and update the code to test RulesEngineResponse
      //var instance = new EdgeApplication.RulesEngineResponse();
      //expect(instance).to.be.a(EdgeApplication.RulesEngineResponse);
    });
