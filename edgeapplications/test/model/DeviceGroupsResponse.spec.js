...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.DeviceGroupsResponse();
  });
  ...
  describe('DeviceGroupsResponse', function() {
    it('should create an instance of DeviceGroupsResponse', function() {
      // uncomment below and update the code to test DeviceGroupsResponse
      //var instance = new EdgeApplication.DeviceGroupsResponse();
      //expect(instance).to.be.a(EdgeApplication.DeviceGroupsResponse);
    });
