...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.ApplicationCacheResponseDetails();
  });
  ...
  describe('ApplicationCacheResponseDetails', function() {
    it('should create an instance of ApplicationCacheResponseDetails', function() {
      // uncomment below and update the code to test ApplicationCacheResponseDetails
      //var instance = new EdgeApplication.ApplicationCacheResponseDetails();
      //expect(instance).to.be.a(EdgeApplication.ApplicationCacheResponseDetails);
    });
    ...
    it('should have the property deviceGroup (base name: "device_group")', function() {
      // uncomment below and update the code to test the property deviceGroup
      //var instance = new EdgeApplication.ApplicationCacheResponseDetails();
      //expect(instance).to.be();
    });
