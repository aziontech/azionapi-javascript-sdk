...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeApplication.ApplicationCacheCreateResults();
  });
  ...
  describe('ApplicationCacheCreateResults', function() {
    it('should create an instance of ApplicationCacheCreateResults', function() {
      // uncomment below and update the code to test ApplicationCacheCreateResults
      //var instance = new EdgeApplication.ApplicationCacheCreateResults();
      //expect(instance).to.be.a(EdgeApplication.ApplicationCacheCreateResults);
    });
