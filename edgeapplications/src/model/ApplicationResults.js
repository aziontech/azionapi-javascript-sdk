...
/**
 * The ApplicationResults model module.
 * @module model/ApplicationResults
 * @version 1.0.0
 */
class ApplicationResults {
    /**
     * Constructs a new <code>ApplicationResults</code>.
     * @alias module:model/ApplicationResults
     * @param id {Number} 
     * @param name {String} 
     ...
     */
    constructor(id, name, active, debugRules, http3, supportedCiphers, deliveryProtocol, httpPort, httpsPort, minimumTlsVersion, applicationAcceleration, caching, deviceDetection, edgeFirewall, edgeFunctions, imageOptimization, l2Caching, loadBalancer, rawLogs, webApplicationFirewall) { 
        
        ApplicationResults.initialize(this, id, name, active, debugRules, http3, supportedCiphers, deliveryProtocol, httpPort, httpsPort, minimumTlsVersion, applicationAcceleration, caching, deviceDetection, edgeFirewall, edgeFunctions, imageOptimization, l2Caching, loadBalancer, rawLogs, webApplicationFirewall);
    }
     ...
     */
    static initialize(obj, id, name, active, debugRules, http3, supportedCiphers, deliveryProtocol, httpPort, httpsPort, minimumTlsVersion, applicationAcceleration, caching, deviceDetection, edgeFirewall, edgeFunctions, imageOptimization, l2Caching, loadBalancer, rawLogs, webApplicationFirewall) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['active'] = active;
    ...
    /**
     * Constructs a <code>ApplicationResults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationResults} obj Optional instance to populate.
     * @return {module:model/ApplicationResults} The populated <code>ApplicationResults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationResults();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationResults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationResults</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationResults.RequiredProperties) {
            if (!data[property]) {
...
ApplicationResults.RequiredProperties = ["id", "name", "active", "debug_rules", "http3", "supported_ciphers", "delivery_protocol", "http_port", "https_port", "minimum_tls_version", "application_acceleration", "caching", "device_detection", "edge_firewall", "edge_functions", "image_optimization", "l2_caching", "load_balancer", "raw_logs", "web_application_firewall"];

/**
 * @member {Number} id
 */
ApplicationResults.prototype['id'] = undefined;
 ...
 */
ApplicationResults.prototype['supported_ciphers'] = undefined;

/**
 * @member {String} delivery_protocol
 */
ApplicationResults.prototype['delivery_protocol'] = undefined;

/**
 * @member {Object} http_port
 */
ApplicationResults.prototype['http_port'] = undefined;

/**
 * @member {Object} https_port
 */
ApplicationResults.prototype['https_port'] = undefined;

/**
 * @member {String} minimum_tls_version
 */
ApplicationResults.prototype['minimum_tls_version'] = undefined;

/**
 * @member {Boolean} application_acceleration
 */
ApplicationResults.prototype['application_acceleration'] = undefined;

/**
 * @member {Boolean} caching
 */
ApplicationResults.prototype['caching'] = undefined;

/**
 * @member {Boolean} device_detection
 */
ApplicationResults.prototype['device_detection'] = undefined;

/**
 * @member {Boolean} edge_firewall
 */
ApplicationResults.prototype['edge_firewall'] = undefined;

/**
 * @member {Boolean} edge_functions
 */
ApplicationResults.prototype['edge_functions'] = undefined;

/**
 * @member {Boolean} image_optimization
 */
ApplicationResults.prototype['image_optimization'] = undefined;

/**
 * @member {Boolean} l2_caching
 */
ApplicationResults.prototype['l2_caching'] = undefined;

/**
 * @member {Boolean} load_balancer
 */
ApplicationResults.prototype['load_balancer'] = undefined;

/**
 * @member {Boolean} raw_logs
 */
ApplicationResults.prototype['raw_logs'] = undefined;

/**
 * @member {Boolean} web_application_firewall
 */
ApplicationResults.prototype['web_application_firewall'] = undefined;
