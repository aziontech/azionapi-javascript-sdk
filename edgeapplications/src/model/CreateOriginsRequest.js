...
/**
 * The CreateOriginsRequest model module.
 * @module model/CreateOriginsRequest
 * @version 1.0.0
 */
class CreateOriginsRequest {
    ...
    /**
     * Constructs a <code>CreateOriginsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateOriginsRequest} obj Optional instance to populate.
     * @return {module:model/CreateOriginsRequest} The populated <code>CreateOriginsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateOriginsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateOriginsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateOriginsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateOriginsRequest.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {String} name
 */
CreateOriginsRequest.prototype['name'] = undefined;

/**
 * @member {String} origin_type
 */
CreateOriginsRequest.prototype['origin_type'] = undefined;

/**
 * @member {Array.<module:model/CreateOriginsRequestAddresses>} addresses
 */
CreateOriginsRequest.prototype['addresses'] = undefined;

/**
 * @member {String} origin_protocol_policy
 */
CreateOriginsRequest.prototype['origin_protocol_policy'] = undefined;

/**
 * @member {String} host_header
 */
CreateOriginsRequest.prototype['host_header'] = undefined;

/**
 * @member {String} origin_path
 */
CreateOriginsRequest.prototype['origin_path'] = undefined;

/**
 * @member {Boolean} hmac_authentication
 */
CreateOriginsRequest.prototype['hmac_authentication'] = undefined;

/**
 * @member {String} hmac_region_name
 */
CreateOriginsRequest.prototype['hmac_region_name'] = undefined;

/**
 * @member {String} hmac_access_key
 */
CreateOriginsRequest.prototype['hmac_access_key'] = undefined;

/**
 * @member {String} hmac_secret_key
 */
CreateOriginsRequest.prototype['hmac_secret_key'] = undefined;
...
export default CreateOriginsRequest;
