...
/**
 * The CreateRulesEngineRequest model module.
 * @module model/CreateRulesEngineRequest
 * @version 1.0.0
 */
class CreateRulesEngineRequest {
    /**
     * Constructs a new <code>CreateRulesEngineRequest</code>.
    ...
    constructor(name, criteria, behaviors) { 
        ...
        CreateRulesEngineRequest.initialize(this, name, criteria, behaviors);
    }
    ...
    /**
     * Constructs a <code>CreateRulesEngineRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRulesEngineRequest} obj Optional instance to populate.
     * @return {module:model/CreateRulesEngineRequest} The populated <code>CreateRulesEngineRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRulesEngineRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRulesEngineRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRulesEngineRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRulesEngineRequest.RequiredProperties) {
            if (!data[property]) {
...
CreateRulesEngineRequest.RequiredProperties = ["name", "criteria", "behaviors"];
...
export default CreateRulesEngineRequest;
