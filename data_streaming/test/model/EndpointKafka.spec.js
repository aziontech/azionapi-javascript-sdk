...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.EndpointKafka();
  });
  ...
  describe('EndpointKafka', function() {
    it('should create an instance of EndpointKafka', function() {
      // uncomment below and update the code to test EndpointKafka
      //var instance = new DataStreamingOpenApi.EndpointKafka();
      //expect(instance).to.be.a(DataStreamingOpenApi.EndpointKafka);
    });
