...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.DataStreamingPostBody();
  });
  ...
  describe('DataStreamingPostBody', function() {
    it('should create an instance of DataStreamingPostBody', function() {
      // uncomment below and update the code to test DataStreamingPostBody
      //var instance = new DataStreamingOpenApi.DataStreamingPostBody();
      //expect(instance).to.be.a(DataStreamingOpenApi.DataStreamingPostBody);
    });
