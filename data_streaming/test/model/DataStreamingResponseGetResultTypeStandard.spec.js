...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeStandard();
  });
  ...
  describe('DataStreamingResponseGetResultTypeStandard', function() {
    it('should create an instance of DataStreamingResponseGetResultTypeStandard', function() {
      // uncomment below and update the code to test DataStreamingResponseGetResultTypeStandard
      //var instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeStandard();
      //expect(instance).to.be.a(DataStreamingOpenApi.DataStreamingResponseGetResultTypeStandard);
    });
