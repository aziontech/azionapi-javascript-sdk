...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.CreateNewDataStreamingRequest();
  });
  ...
  describe('CreateNewDataStreamingRequest', function() {
    it('should create an instance of CreateNewDataStreamingRequest', function() {
      // uncomment below and update the code to test CreateNewDataStreamingRequest
      //var instance = new DataStreamingOpenApi.CreateNewDataStreamingRequest();
      //expect(instance).to.be.a(DataStreamingOpenApi.CreateNewDataStreamingRequest);
    });
    ...
    it('should have the property samplingPercentage (base name: "sampling_percentage")', function() {
