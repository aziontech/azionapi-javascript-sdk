...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.EndpointAWSKinesisFirehose();
  });
  ...
  describe('EndpointAWSKinesisFirehose', function() {
    it('should create an instance of EndpointAWSKinesisFirehose', function() {
      // uncomment below and update the code to test EndpointAWSKinesisFirehose
      //var instance = new DataStreamingOpenApi.EndpointAWSKinesisFirehose();
      //expect(instance).to.be.a(DataStreamingOpenApi.EndpointAWSKinesisFirehose);
    });
