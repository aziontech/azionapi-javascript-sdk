...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.EndpointDefault();
  });
  ...
  describe('EndpointDefault', function() {
    it('should create an instance of EndpointDefault', function() {
      // uncomment below and update the code to test EndpointDefault
      //var instance = new DataStreamingOpenApi.EndpointDefault();
      //expect(instance).to.be.a(DataStreamingOpenApi.EndpointDefault);
    });
