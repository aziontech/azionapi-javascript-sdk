...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeDatadogDTS();
  });
  ...
  describe('DataStreamingResponseGetResultTypeDatadogDTS', function() {
    it('should create an instance of DataStreamingResponseGetResultTypeDatadogDTS', function() {
      // uncomment below and update the code to test DataStreamingResponseGetResultTypeDatadogDTS
      //var instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeDatadogDTS();
      //expect(instance).to.be.a(DataStreamingOpenApi.DataStreamingResponseGetResultTypeDatadogDTS);
    });
