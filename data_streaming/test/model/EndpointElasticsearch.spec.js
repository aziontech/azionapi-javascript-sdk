...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.EndpointElasticsearch();
  });
  ...
  describe('EndpointElasticsearch', function() {
    it('should create an instance of EndpointElasticsearch', function() {
      // uncomment below and update the code to test EndpointElasticsearch
      //var instance = new DataStreamingOpenApi.EndpointElasticsearch();
      //expect(instance).to.be.a(DataStreamingOpenApi.EndpointElasticsearch);
    });
