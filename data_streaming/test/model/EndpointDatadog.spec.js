...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.EndpointDatadog();
  });
  ...
  describe('EndpointDatadog', function() {
    it('should create an instance of EndpointDatadog', function() {
      // uncomment below and update the code to test EndpointDatadog
      //var instance = new DataStreamingOpenApi.EndpointDatadog();
      //expect(instance).to.be.a(DataStreamingOpenApi.EndpointDatadog);
    });
