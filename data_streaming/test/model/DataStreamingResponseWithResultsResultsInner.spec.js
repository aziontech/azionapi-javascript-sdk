...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.DataStreamingResponseWithResultsResultsInner();
  });
  ...
  describe('DataStreamingResponseWithResultsResultsInner', function() {
    it('should create an instance of DataStreamingResponseWithResultsResultsInner', function() {
      // uncomment below and update the code to test DataStreamingResponseWithResultsResultsInner
      //var instance = new DataStreamingOpenApi.DataStreamingResponseWithResultsResultsInner();
      //expect(instance).to.be.a(DataStreamingOpenApi.DataStreamingResponseWithResultsResultsInner);
    });
