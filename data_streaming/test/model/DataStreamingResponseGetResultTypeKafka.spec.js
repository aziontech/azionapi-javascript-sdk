...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeKafka();
  });
  ...
  describe('DataStreamingResponseGetResultTypeKafka', function() {
    it('should create an instance of DataStreamingResponseGetResultTypeKafka', function() {
      // uncomment below and update the code to test DataStreamingResponseGetResultTypeKafka
      //var instance = new DataStreamingOpenApi.DataStreamingResponseGetResultTypeKafka();
      //expect(instance).to.be.a(DataStreamingOpenApi.DataStreamingResponseGetResultTypeKafka);
    });
