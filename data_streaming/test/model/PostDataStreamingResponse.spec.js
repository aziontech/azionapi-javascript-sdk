...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataStreamingOpenApi.PostDataStreamingResponse();
  });
  ...
  describe('PostDataStreamingResponse', function() {
    it('should create an instance of PostDataStreamingResponse', function() {
      // uncomment below and update the code to test PostDataStreamingResponse
      //var instance = new DataStreamingOpenApi.PostDataStreamingResponse();
      //expect(instance).to.be.a(DataStreamingOpenApi.PostDataStreamingResponse);
    });
