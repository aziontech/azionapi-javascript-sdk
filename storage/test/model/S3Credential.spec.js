...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ObjectStorage.S3Credential();
  });
  ...
  describe('S3Credential', function() {
    it('should create an instance of S3Credential', function() {
      // uncomment below and update the code to test S3Credential
      //var instance = new ObjectStorage.S3Credential();
      //expect(instance).to.be.a(ObjectStorage.S3Credential);
    });
