...
* <pre>
* var Variables = require('index'); // See note below*.
* var xxxSvc = new Variables.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new Variables.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new Variables.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new Variables.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
