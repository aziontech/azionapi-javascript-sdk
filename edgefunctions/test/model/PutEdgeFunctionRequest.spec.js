...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeFunction.PutEdgeFunctionRequest();
  });
  ...
  describe('PutEdgeFunctionRequest', function() {
    it('should create an instance of PutEdgeFunctionRequest', function() {
      // uncomment below and update the code to test PutEdgeFunctionRequest
      //var instance = new EdgeFunction.PutEdgeFunctionRequest();
      //expect(instance).to.be.a(EdgeFunction.PutEdgeFunctionRequest);
    });
