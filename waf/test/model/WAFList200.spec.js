...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebApplicationFirewallApi.WAFList200();
  });
  ...
  describe('WAFList200', function() {
    it('should create an instance of WAFList200', function() {
      // uncomment below and update the code to test WAFList200
      //var instance = new WebApplicationFirewallApi.WAFList200();
      //expect(instance).to.be.a(WebApplicationFirewallApi.WAFList200);
    });
