...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebApplicationFirewallApi.SingleWAF();
  });
  ...
  describe('SingleWAF', function() {
    it('should create an instance of SingleWAF', function() {
      // uncomment below and update the code to test SingleWAF
      //var instance = new WebApplicationFirewallApi.SingleWAF();
      //expect(instance).to.be.a(WebApplicationFirewallApi.SingleWAF);
    });
