...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalCertificatesApi.SingleResult();
  });
  ...
  describe('SingleResult', function() {
    it('should create an instance of SingleResult', function() {
      // uncomment below and update the code to test SingleResult
      //var instance = new DigitalCertificatesApi.SingleResult();
      //expect(instance).to.be.a(DigitalCertificatesApi.SingleResult);
    });
