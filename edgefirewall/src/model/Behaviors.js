...
class Behaviors {
     ...
     * @param {(module:model/NullArgumentBehavior|module:model/SetRateLimitBehavior|module:model/SetWAFRuleSetBehavior|module:model/SimpleArgumentBehavior)} instance The actual instance to initialize Behaviors.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `Behaviors` with oneOf schemas NullArgumentBehavior, SetRateLimitBehavior, SetWAFRuleSetBehavior, SimpleArgumentBehavior. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `Behaviors` with oneOf schemas NullArgumentBehavior, SetRateLimitBehavior, SetWAFRuleSetBehavior, SimpleArgumentBehavior. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>NullArgumentBehavior</code>, <code>SetRateLimitBehavior</code>, <code>SetWAFRuleSetBehavior</code>, <code>SimpleArgumentBehavior</code>.
     * @return {(module:model/NullArgumentBehavior|module:model/SetRateLimitBehavior|module:model/SetWAFRuleSetBehavior|module:model/SimpleArgumentBehavior)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>NullArgumentBehavior</code>, <code>SetRateLimitBehavior</code>, <code>SetWAFRuleSetBehavior</code>, <code>SimpleArgumentBehavior</code>.
     * @param {(module:model/NullArgumentBehavior|module:model/SetRateLimitBehavior|module:model/SetWAFRuleSetBehavior|module:model/SimpleArgumentBehavior)} obj The actual instance.
     */
...
Behaviors.OneOf = ["NullArgumentBehavior", "SetRateLimitBehavior", "SetWAFRuleSetBehavior", "SimpleArgumentBehavior"];
