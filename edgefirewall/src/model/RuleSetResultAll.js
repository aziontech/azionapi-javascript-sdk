...
/**
 * The RuleSetResultAll model module.
 * @module model/RuleSetResultAll
 * @version 2.0.0
 */
class RuleSetResultAll {
    /**
     * Constructs a new <code>RuleSetResultAll</code>.
     * @alias module:model/RuleSetResultAll
     */
    constructor() { 
        
        RuleSetResultAll.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleSetResultAll</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleSetResultAll} obj Optional instance to populate.
     * @return {module:model/RuleSetResultAll} The populated <code>RuleSetResultAll</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleSetResultAll();
    ...
    /**
     * Validates the JSON data with respect to <code>RuleSetResultAll</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleSetResultAll</code>.
     */
 ...
 * @member {Number} id
 */
RuleSetResultAll.prototype['id'] = undefined;

/**
 * @member {String} last_editor
 */
RuleSetResultAll.prototype['last_editor'] = undefined;

/**
 * @member {Date} last_modified
 */
RuleSetResultAll.prototype['last_modified'] = undefined;

/**
 * @member {String} name
 */
RuleSetResultAll.prototype['name'] = undefined;

/**
 * @member {Boolean} is_active
 */
RuleSetResultAll.prototype['is_active'] = undefined;

/**
 * @member {String} description
 */
RuleSetResultAll.prototype['description'] = undefined;

/**
 * @member {Array.<module:model/Behaviors>} behaviors
 */
RuleSetResultAll.prototype['behaviors'] = undefined;

/**
 * @member {Array.<Array.<module:model/SSLVerificationStatusCriteria>>} criteria
 */
RuleSetResultAll.prototype['criteria'] = undefined;

/**
 * @member {Number} order
 */
RuleSetResultAll.prototype['order'] = undefined;
...
export default RuleSetResultAll;
