...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeFirewallApi.CreateRuleSetRequest();
  });
  ...
  describe('CreateRuleSetRequest', function() {
    it('should create an instance of CreateRuleSetRequest', function() {
      // uncomment below and update the code to test CreateRuleSetRequest
      //var instance = new EdgeFirewallApi.CreateRuleSetRequest();
      //expect(instance).to.be.a(EdgeFirewallApi.CreateRuleSetRequest);
    });
