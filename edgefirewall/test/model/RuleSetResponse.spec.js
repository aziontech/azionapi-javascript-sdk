...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeFirewallApi.RuleSetResponse();
  });
  ...
  describe('RuleSetResponse', function() {
    it('should create an instance of RuleSetResponse', function() {
      // uncomment below and update the code to test RuleSetResponse
      //var instance = new EdgeFirewallApi.RuleSetResponse();
      //expect(instance).to.be.a(EdgeFirewallApi.RuleSetResponse);
    });
