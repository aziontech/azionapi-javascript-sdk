...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EdgeFirewallApi.RuleSetResultAll();
  });
  ...
  describe('RuleSetResultAll', function() {
    it('should create an instance of RuleSetResultAll', function() {
      // uncomment below and update the code to test RuleSetResultAll
      //var instance = new EdgeFirewallApi.RuleSetResultAll();
      //expect(instance).to.be.a(EdgeFirewallApi.RuleSetResultAll);
    });
