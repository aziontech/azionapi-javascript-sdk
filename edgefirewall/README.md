...
EdgeFirewallApi - JavaScript client for edge_firewall_api
...
```shell
npm install edge_firewall_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your edge_firewall_api from, and run:
...
```javascript
var EdgeFirewallApi = require('edge_firewall_api');

var defaultClient = EdgeFirewallApi.ApiClient.instance;
...
*EdgeFirewallApi.DefaultApi* | [**edgeFirewallUuidGet**](docs/DefaultApi.md#edgeFirewallUuidGet) | **GET** /edge_firewall/{uuid} | Retrieve an edge firewall set by uuid
*EdgeFirewallApi.DefaultApi* | [**edgeFirewallUuidPatch**](docs/DefaultApi.md#edgeFirewallUuidPatch) | **PATCH** /edge_firewall/{uuid} | Update some edge firewall attributes, like \&quot;active\&quot;
*EdgeFirewallApi.DefaultApi* | [**edgeFirewallUuidPut**](docs/DefaultApi.md#edgeFirewallUuidPut) | **PUT** /edge_firewall/{uuid} | Overwrite some edge firewall attributes, like \&quot;active\&quot;
...
## Documentation for Models
 ...
 - [EdgeFirewallApi.NullArgumentBehavior](docs/NullArgumentBehavior.md)
 ...
 - [EdgeFirewallApi.SetCustomResponse](docs/SetCustomResponse.md)
 - [EdgeFirewallApi.SetCustomResponseArgument](docs/SetCustomResponseArgument.md)
 - [EdgeFirewallApi.SetCustomResponseArgumentStatusCode](docs/SetCustomResponseArgumentStatusCode.md)
 - [EdgeFirewallApi.SetRateLimitBehavior](docs/SetRateLimitBehavior.md)
 - [EdgeFirewallApi.SetRateLimitBehaviorArgument](docs/SetRateLimitBehaviorArgument.md)
 - [EdgeFirewallApi.SetRateLimitBehaviorArgumentAverageRateLimit](docs/SetRateLimitBehaviorArgumentAverageRateLimit.md)
 - [EdgeFirewallApi.SetWAFRuleSetAndWafModeBehavior](docs/SetWAFRuleSetAndWafModeBehavior.md)
 - [EdgeFirewallApi.SetWAFRuleSetAndWafModeBehaviorArgument](docs/SetWAFRuleSetAndWafModeBehaviorArgument.md)
 - [EdgeFirewallApi.SetWAFRuleSetBehavior](docs/SetWAFRuleSetBehavior.md)
 - [EdgeFirewallApi.SetWAFRuleSetBehaviorArgument](docs/SetWAFRuleSetBehaviorArgument.md)
 - [EdgeFirewallApi.SimpleArgumentBehavior](docs/SimpleArgumentBehavior.md)
 - [EdgeFirewallApi.SimpleArgumentBehaviorArgument](docs/SimpleArgumentBehaviorArgument.md)
