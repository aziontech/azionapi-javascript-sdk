...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Domain.DomainsApi();
  });
  ...
  describe('DomainsApi', function() {
    ...
    describe('delDomain', function() {
      it('should call delDomain successfully', function(done) {
        //uncomment below and update the code to test delDomain
        //instance.delDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putDomain', function() {
      it('should call putDomain successfully', function(done) {
        //uncomment below and update the code to test putDomain
        //instance.putDomain(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
