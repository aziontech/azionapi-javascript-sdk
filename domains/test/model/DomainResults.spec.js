...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Domain.DomainResults();
  });
  ...
  describe('DomainResults', function() {
    it('should create an instance of DomainResults', function() {
      // uncomment below and update the code to test DomainResults
      //var instance = new Domain.DomainResults();
      //expect(instance).to.be.a(Domain.DomainResults);
    });
