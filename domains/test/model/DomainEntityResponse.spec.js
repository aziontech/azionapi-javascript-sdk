...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DomainApi.DomainEntityResponse();
  });
  ...
  describe('DomainEntityResponse', function() {
    it('should create an instance of DomainEntityResponse', function() {
      // uncomment below and update the code to test DomainEntityResponse
      //var instance = new DomainApi.DomainEntityResponse();
      //expect(instance).to.be.a(DomainApi.DomainEntityResponse);
    });
    ...
    it('should have the property edgeFirewallId (base name: "edge_firewall_id")', function() {
      // uncomment below and update the code to test the property edgeFirewallId
      //var instance = new DomainApi.DomainEntityResponse();
      //expect(instance).to.be();
    });
