...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Domain.PutDomainRequest();
  });
  ...
  describe('PutDomainRequest', function() {
    it('should create an instance of PutDomainRequest', function() {
      // uncomment below and update the code to test PutDomainRequest
      //var instance = new Domain.PutDomainRequest();
      //expect(instance).to.be.a(Domain.PutDomainRequest);
    });
