...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DomainApi.DomainDataResponse();
  });
  ...
  describe('DomainDataResponse', function() {
    it('should create an instance of DomainDataResponse', function() {
      // uncomment below and update the code to test DomainDataResponse
      //var instance = new DomainApi.DomainDataResponse();
      //expect(instance).to.be.a(DomainApi.DomainDataResponse);
    });
